...
export const INITIAL_PREDICTION_HISTORY: PredictionHistoryRecord[] = [
  {
    id: 'pred-101',
    date: '10 Sep 2026',
    imageName: 'leaf_001.jpg',
    imageUrl: '/samples/blotch_sample.jpg',
    disease: 'Blotch',
    confidence: 94.6,
    environmentalRisk: 71,
    overallRisk: 78,
    status: 'High',
    notes: 'Severe blotch lesions identified. High microclimate humidity accelerated risk score.',
    parameters: {
      temperature: 29.4,
      humidity: 78,
      rainfall: 12.5,
  ...
  },
  {
    id: 'pred-102',
    date: '09 Sep 2026',
    imageName: 'leaf_002.jpg',
    imageUrl: '/samples/healthy_sample.jpg',
    disease: 'Healthy',
    confidence: 97.2,
    environmentalRisk: 22,
    overallRisk: 14,
    status: 'Low',
    notes: 'Clean vegetative state with well-balanced microclimate metrics.',
    parameters: {
      temperature: 25.8,
      humidity: 50,
      rainfall: 0.0,
  ...
  },
  {
    id: 'pred-103',
    date: '08 Sep 2026',
    imageName: 'leaf_003.jpg',
    imageUrl: '/samples/leaf_spot_sample.jpg',
    disease: 'Leaf Spot',
    confidence: 91.4,
    environmentalRisk: 63,
    overallRisk: 67,
    status: 'Moderate',
    notes: 'Localized concentric leaf spots detected during moderate post-dusk wetness.',
    parameters: {
      temperature: 28.1,
      humidity: 71,
      rainfall: 6.4,
  ...
  },
  {
    id: 'pred-104',
    date: '07 Sep 2026',
    imageName: 'leaf_004.jpg',
    imageUrl: '/samples/aphids_sample.jpg',
    disease: 'Aphids',
    confidence: 93.8,
    environmentalRisk: 58,
    overallRisk: 69,
    status: 'Moderate-High',
    notes: 'Sap-feeding aphids observed along midrib under high temperature conditions.',
    parameters: {
      temperature: 31.4,
      humidity: 59,
      rainfall: 0.8,
  ...
  },
  {
    ...
    overallRisk: 81,
    status: 'High',
    notes: 'High rainfall event accompanied by extensive leaf blotch colonization.',
    parameters: {
      temperature: 28.7,
      humidity: 82,
      rainfall: 18.2,
